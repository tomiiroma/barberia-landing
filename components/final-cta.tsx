    ...
    <section className="relative py-20 md:py-32 px-4 overflow-hidden bg-foreground">
      ...
      <div className="container relative mx-auto max-w-3xl text-center">
        ...
        <p className="text-lg md:text-xl text-white/60 mb-8 max-w-xl mx-auto leading-relaxed text-pretty">
          Miles de mujeres ya dieron el primer paso. Te acompañamos en todo el proceso hacia la versión de vos que querés
          ser.
        </p>
        ...
        <p className="text-sm text-white/40 mt-4">Respondemos en el día · Sin compromiso · Gratis</p>
      </div>
    </section>
  )
}
