          ...
          {featured.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`inline-flex items-center text-xs font-semibold px-2.5 py-1 rounded-full mb-4 ${item.badgeStyle}`}
                >
                  {item.badge}
                </span>
                ...
                <p className="text-sm md:text-base text-foreground/70 mb-5 leading-relaxed">{item.description}</p>
