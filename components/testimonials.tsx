    ...
    <section className="py-20 md:py-28 px-4 bg-secondary/30">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-14">
          <p className="text-sm font-medium text-primary uppercase tracking-widest mb-3">Testimonios</p>
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-4 text-balance">
            Lo que dicen
            <br className="hidden md:block" /> nuestras pacientes
          </h2>
          <p className="text-lg text-muted-foreground max-w-xl mx-auto text-pretty">Resultados reales, experiencias reales.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {testimonials.map((t) => (
            ...
            >
              ...
              <p className="text-sm md:text-base text-foreground/75 leading-relaxed mb-6 italic">&ldquo;{t.text}&rdquo;</p>
